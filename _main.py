...
def countdown3(numberOfSecTrafficFour):
    x = time.time() + numberOfSecTrafficFour
    while time.time() < x:
...
while True:
    ...
    if laplacian and laplacian1 and laplacian2 and laplacian3 > 0:
        ...
        print(numberOfSecTrafficTwo)
        print(numberOfSecTrafficThree)
        print(numberOfSecTrafficFour)
        time.sleep(60)
